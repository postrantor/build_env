...
#  Example usage:
#  @code
#  sudo -E bash ${ROS2_WORKDIR}/.env/update-rosdep.bash
#  @endcode
function update-rosdep() {
...
## @function import-ros2-src
#  @brief Import ros2 robot source repositories using vcs.
#
#  This function imports the source repositories specified in the `ROS2_REPO`
...
function import-ros2-src() {
  ...
  if ! vcs import --retry 3 --force --workers 5 --input "${ROS2_REPO}" ./src; then
...
#  @endcode
function ignore-directory() {
  local ignore_file="${ROS2_WORKDIR}/src/.colcon-ignore-$1"
